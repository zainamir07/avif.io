...
(() => {
  ...
  function s(e) {
    ...
    return n[e](t, t.exports, s), (t.loaded = !0), t.exports;
  }
  (s.m = n),
    (e =
    ...
    (s.a = (n, a, s) => {
      ...
      (f[r] = d),
        (f[e] = (e) => (i && e(i), b.forEach(e), f.catch((e) => {}))),
        (n.exports = f),
        a(
          (n) => {
            var a;
  ...
  async function p() {
    ...
    return (r.memory = t.memory), r;
  }
  s.r(i), s.d(i, { lib: () => p }), (conversion = i);
})();
