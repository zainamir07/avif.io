...
export function __wbg_get_conversionoptions_adaptive(a: number): number;
export function __wbg_set_conversionoptions_adaptive(a: number, b: number): void;
export function conversionoptions_new(a: number, b: number, c: number, d: number, e: number): number;
...
export function convert_to_avif(a: number, b: number, c: number): number;
export function rgba_to_avif(a: number, b: number, c: number, d: number, e: number): number;
