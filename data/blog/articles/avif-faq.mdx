...
sources:
  ...
  - aomedia.org/wp-content/uploads/2019/11/CyrilConcolato_Netflix-AVIF-AOM-Research-Symposium-2019.pdf
...
AVIF images are longer to encode and create. For sites that create images dynamically, this could cause problems. Encoding speed is, however, being improved by the AVIF team.
...
All programs do not yet support it (e.g., Adobe Photoshop), and only 70% of current user browsers can display AVIF images.
...
<Checklist
  ...
  items={[
    ...
    "Opera (since 15 September 2020, version 71)",
    "Samsung Internet (since 16 April, version 14)",
    "Vivaldi",
  ]}
/>
...
<Checklist checked items={["Outlook", "Thunderbird", "Yahoo Mail"]} />
