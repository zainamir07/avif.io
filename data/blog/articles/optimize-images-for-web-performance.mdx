...
##### Summary: Configure a cache-control header with a high max-age so users don’t have to download images multiple times. Use an image CDN and disable hotlinking to optimize your ressources
