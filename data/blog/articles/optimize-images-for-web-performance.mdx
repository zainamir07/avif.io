...
description: Straightforward optimization tips, for beginners and experts.
...
<Checklist
  ...
  checked={true}
/>
## Introduction ##### Summary: Images are a huge part of the web. Performance is
...
<Checklist
  ...
  checked={true}
/>
## 2) Efficiently encode images ##### Summary: Always compress images. Find a good
...
<Checklist
  ...
  checked={true}
/>
## 4) Optimize image loading process ##### Summary: Optimize the loading process
...
## 5) Improve hosting behavior ##### Summary: Configure a cache-control header with
...
<Checklist
  ...
  checked={true}
/>
## 6) SEO Image Optimization ##### Summary: Use an explanatory file name as well
...
But apart from speeding up loading times, image optimization for SEO also involves contextualizing images so that visitors and search engines can understand them more easily. SEO image optimization differs from the more comprehensive image optimization described above.
