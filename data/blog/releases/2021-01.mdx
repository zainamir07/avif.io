...
Yada yada.some misc stuff I thought I should write into this changelog, even though you most likely won't care.
...
- Added an explainer to the settings box that effectstake place for newly uploaded files
