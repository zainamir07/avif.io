...
description: We are open-source!! This release focused on 'under the hood' changes, like upgrading dependencies, switching to TailwindCSS and moving to NextJS 11.
...
<Link text="Github." link="github.com/justinschmitz97/avif.io/" ext></Link>
