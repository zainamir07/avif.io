...
An AVIF file performs excellently with low-fidelity lossy image compression. A compressed AVIF image retains high-appeal, meaning it avoids annoying compression artifacts like color banding. Low-fidelity AVIF images look fantastic while also keeping the file size down.  
...
For most people, **images encoded in AVIF and images encoded in JPEG XL will besimilar.** Yes, JPEG XL is faster, but most users won't notice this difference. Both do incredibly well with maintaining appeal when compressed so that web pictures will look great, especially compared to the old legacy JPEG standard.  
