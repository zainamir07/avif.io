...
Animated GIFs have hada resurgence in recent years. We expect the demand for animated images to grow as the web becomes more interactive. However, the GIF format **is too limited to deliver high-quality animated images**, and that’s where AVIF steps in to solve this problem.
