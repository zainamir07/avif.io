...
tags:
  ...
  - avif image
sources:
  - downloads.aomedia.org/assets/pdf/AV1-HDR10-Implementation-Note_1202.pdf
...
Both AVIF and JPEG XR support wide color gamuts and HDR images. JPEG XR supports a max bit depth of 32-bits (or deep color), whereas AVIF has a max precision of 12-bits. This may be a significant distance, but we have found that 12-bit precision is good enough for image delivery.those with authoring workflows can generally benefit from higher bit depths. Both formats can also do 4:4:4.
...
JPEG XR is renowned for its low computational and memory resource requirements. Therefore JXR encodes and decodes speeds are generally fast on even underpowered hardware.
...
AVIF supports overlays and depth maps. Overlays allow for layers to help maintain the clarity of text and graphics over compressed photo backgrounds. Depth maps enable effects to be added to foregrounds and backgrounds. **JPEG XR doesn’t support these features.**
...
The future is looking bright for AVIF’s browser support. JPEG XR not enjoyed any browser success outside of Internet Explorer and the initial builds of Edge, and it has been replaced by JPEG XL. It’s hard to see this situation improving for JXR in any way.
...
AVIF is a powerful image file format. Its low-fidelity high-appeal performance will make it a popular and valuable format for web images. Users should be glad to see away entirely obsolete formats like GIF for animated images and enjoy the excellent quality of compressed AVIF images and animations.
