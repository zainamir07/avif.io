...
As an image codec that finds its roots in frames of AV1 video, AVIF **has an image resolution limitof 65536 x 65536 pixels**. Still, there tend to be artifacts at the tile boundaries of 8K frames if you use this method. This makes large-resolution AVIF images generally undesirable.
