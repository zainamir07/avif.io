...
JPEG 2000 has had a tough 21 years attempting to gain mainstream support from web browsers. Apart from **full support from Safari** since Safari 5 in 2010, **no other major web browser supports JPEG 2000\.** This is a reasonably damaging statistic, given Safari has a market share of9.7% on desktop.
...
In many aspects, JPEG 2000 was aforward-thinking image format. With its support for high-bit depth photos and astronomical image dimension limits, **JPEG 2000 is a truly impressive format on the spec sheet.**
