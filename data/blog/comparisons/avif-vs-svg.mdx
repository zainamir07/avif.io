...
**When decoding SVG images, a computer does not have to process an entire pixel grid anddraws lines.** Therefore, it is swift to encode and decode SVG files, and many web admins use SVG graphics over PNG (and AVIF) to improve page load times.
