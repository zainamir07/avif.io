...
An animated image with a file size of 1.5MB and 67 frames can be converted to a sequenced AVIF file of87kb. The benefits of this dramatically more efficient animation compression become even more significant the longer and more detailed animated images become.
