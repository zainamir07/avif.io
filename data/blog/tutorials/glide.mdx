...
datePublished: 26.10.21
dateModified: 26.10.21
sources:
...
On the 26th of October, Glide v2.1.0 was released. It offers full support for the AVIF format. You can utilize the format and perform operations just like with any other image file.
