...
In our Tutorial on <Link href="/blog/tutorials/use-avif-in-html/" text="how to use avif in HTML" />, we present you the `<picture>` element as the best option to serve AVIF files in an HTML environment. Cloudflare allows you to use their image optimization endpoint to perform the conversion if you do not want to use Workers.
