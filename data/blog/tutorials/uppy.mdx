...
description: Uppy is a sleek, modular JavaScript file uploader that now supports AVIF.
keyword: Uppy
category: tutorials
subcategory: coding
support: full support
url: blog/tutorials/uppy/
datePublished: 29.07.20
...
Since the 29th of July 2020, Uppy supports handling of AVIF files. Even though the file upload has always worked, it now supports fully displaying image thumbnails as well.
