...
We could argue that AVIF is a new extension. Considering that WebP is more than ten years old and wasrecently adopted, the question arises whether WordPress will ever add support for modern image formats. Fortunately, there are several ways around this security check.
...
This solution is meant to be used with caution, since it completely disables the mime type check.
