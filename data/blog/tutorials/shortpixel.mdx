...
Netflix published images in the AVIF format for the first time in February 2018 and since then, more applications and companies have added support for it, although at aslow pace. Today, we can find AVIF support in Google Chrome, VLC, and GIMP, and companies like Microsoft are jumping on board. Earlier this year, Netflix published a blog article with objective measurements comparing the image quality and compression efficiency of AVIF to JPEG.
