...
A plugin called ShortPixel Image Optimizer (SPIO) allows you to optimize the physical images on your installation. Itworks locally, so it physically compresses the images you upload to your website.
