...
This development version of VLC Media Player 4.0.0 -dev Otto Chriek supports notthe opening of AVIF images but also the playback of AVIFS animations. Support was buggy years ago, but it seems that most of these issues have been resolved by now. The release date of 4.0 is not yet known. In the meantime, you can try the nightly builds. Open VLC and drag the AVIF file into it, or open the file from the File menu.
