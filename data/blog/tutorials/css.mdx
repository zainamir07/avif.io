...
Using AVIF images via HTML iseasy as you can read <Link text="in this tutorial." href="/blog/tutorials/html/" />
...
If it isunlikely that your browser will not pass this test, the HTML element will get a class called 'fallback'.
