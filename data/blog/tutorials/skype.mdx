...
To this date,a forum post exists that suggests adding support for AVIF. The post did not get much traction. Skype downloads but does not display AVIF files. It is uncertain whether Skype will add support in the future.
