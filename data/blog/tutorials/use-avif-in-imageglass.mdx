...
description: Find out how you can use AVIF images in ImageGlass.
url: blog/tutorials/use-avif-in-imageglass/
image: "/logo_draft.png"
datePublished: 10.12.20
dateModified: 31.08.21
support: yes
sources:
  - ghacks.net/2020/12/10/image-viewer-imageglass-8-0-is-out-with-major-improvements/
  - imageglass.org/
  - github.com/d2phap/ImageGlass
  - imageglass.org/news
  - imageglass.org/news/announcing-imageglass-8-0-kobe-70
  - reddit.com/r/AV1/comments/kel9ks/avif_support_added_to_imageglass_a_free_windows/
