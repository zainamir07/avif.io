...
This may be due to the reason that Google does not want its users to perceive that every mail client will show the inlined AVIF image. As AVIF still has 60% browser support, other users may not see the image.
