...
<Link link="imagekit.io/" text="Homepage" ext />·
<Link link="wordpress.org/plugins/imagekit/" text="WP Plugin" ext />·
<Link
  link="docs.imagekit.io/platform-guides/wordpress"
  text="WP Tutorial"
  ext
/>
·
<Link
  link="imagekit.io/blog/automatic-avif-image-optimization-imagekit/"
  text="AVIF article"
  ext
/>
...
<Link link="cloudinary.com/" text="Homepage" ext />·
<Link
  link="wordpress.org/plugins/cloudinary-image-management-and-manipulation-in-the-cloud-cdn/"
  text="WP Plugin"
  ext
/>·
<Link
  link="cloudinary.com/documentation/wordpress_integration"
  text="WP Tutorial"
  ext
/>
·
<Link
  link="cloudinary.com/blog/how_to_adopt_avif_for_images_with_cloudinary"
  text="AVIF article"
  ext
/>
...
<Link link="imageengine.io" text="Homepage" ext />·
<Link link="wordpress.org/plugins/image-cdn/" text="WP Plugin" ext />·
<Link
  link="imageengine.io/wordpress-woocommerce-image-cdn"
  text="WP Tutorial"
  ext
/>
·
<Link link="imageengine.io/avif-image-format" text="AVIF article" ext />
...
<Link link="shortpixel.com/" text="Homepage" ext />·
<Link
  link="wordpress.org/plugins/shortpixel-image-optimiser/"
  text="WP Plugin"
  ext
/>·
<Link
  link="blog.shortpixel.com/shortpixel-image-optimizer-the-only-wp-plugin-that-creates-avif-images/"
  text="WP Tutorial"
  ext
/>
·
<Link
  link="https://blog.shortpixel.com/what-is-avif-and-why-is-it-good/"
  text="AVIF article"
  ext
/>
...
<Link link="www.imghaste.com/" text="Homepage" ext />·
<Link link="wordpress.org/plugins/imghaste/" text="WP Plugin" ext />·
<Link
  link="help.imghaste.com/show/can-i-integrate-my-wordpress-website"
  text="WP Tutorial"
  ext
/>
·
<Link
  link="www.imghaste.com/blog/concerns-raised-about-avif-early-adopters"
  text="AVIF article"
  ext
/>
...
<Link link="www.twicpics.com/" text="Homepage" ext />·
<Link link="wordpress.org/plugins/twicpics/" text="WP Plugin" ext />·
<Link
  link="www.twicpics.com/docs/guides/wordpress-plugin"
  text="WP Tutorial"
  ext
/>
·
<Link
  link="www.twicpics.com/docs/api/transformations#output"
  text="AVIF article"
  ext
/>
...
<Link link="www.gumlet.com" text="Homepage" ext />·
<Link link="wordpress.org/plugins/gumlet/" text="WP Plugin" ext />·
<Link link="www.gumlet.com/wordpress" text="WP Tutorial" ext />·
<Link
  link="www.gumlet.com/blog/worlds-first-service-to-provide-avif-support/"
  text="AVIF article"
  ext
/>
...
<Link link="wordpress.org/plugins/modern-images-wp/" text="WP Plugin" ext />·
<Link
  link="github.com/adamsilverstein/modern-images-wp"
  text="WP Tutorial"
  ext
/>
