...
It is possible to upload JPGs and PNGs. Instagram also displays images in JPG format.
It may be due to the large size of the images uploaded to Instagram. Since WebP still
does not have 100% support and AVIF has 60% support, Instagram would have to serve
multiple image formats to ensure that all their users' devices are supported. The
amount of storage required would be huge, with more than 50 billion photos, without
including resized images for different devices.
