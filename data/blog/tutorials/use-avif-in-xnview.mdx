...
description: View, resize and edit your phots - now with AVIF support! FFind out how you can use AVIF images in XnView.
keyword: XnView
category: tutorials
subcategory: graphics
support: full support
url: blog/tutorials/use-avif-in-xnview/
...
XnView has added AVIF support with the 0.96 release. You can open any image using the viewer as you normally would.
