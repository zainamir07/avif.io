...
LinkedIn supports AVIF! The state of AVIF support on LinkedIn is complicated. When you are uploading an AVIF image, you are shown an image error symbol. The browser console displays along error message.
