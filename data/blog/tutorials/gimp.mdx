...
description: GIMP 2.10.22 includes HEIC support and AVIF support. Learn how to
...
image. We recommend a value above 20.

You can also save files with lossless compression.
...
and want to use the AVIF format for images for your website, we recommend sticking
...
If you look to have many images converted, it's a lot easier to convert them all in one go. Make life easier for yourself by <Link text="using our AVIF converter, which is free." href="/" />
