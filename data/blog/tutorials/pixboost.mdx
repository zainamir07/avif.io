...
Pixboost also offers their service to be used though an own infrastructure using a <Link href="https://github.com/Pixboost/transformimgs" text="docker image"/>.
