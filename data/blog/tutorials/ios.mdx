...
As soon as Apple decides to support the format, we can expect a massive switch to give support to all of Apple's ecosystem. In fact, support for their browser Safari depends on OS support, as we explained in our Safari article.
