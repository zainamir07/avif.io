...
As of right now, Discord istargeting encoders with first-class hardware encoder support (as well as webRTC support). AV1 is not currently one of those encoders.
