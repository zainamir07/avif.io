...
To this date, Google Imagesallows uploading JPG, GIF, PNG, BMP, TIF, and WEBP. There are no official plans to support AVIF. Given that Google is one of the developers of AVIF, we may see support in the future.
