...
Slack has no AVIF support. Weirdly enough, it visually displays the image in the uploading process, then grays it out andlet's you download it like a regular sent file. Slack does not allow viewing AVIF inline and there are no public plans to whether they will add support in future.

<Image
  src="slack-chat"
  alt="slack chat visuall showing the AVIF image while uploading"
/>
<Image src="slack-upload" alt="slack not anymore showing the image" />
<Image
  src="slack-upload-after"
