...
description: GIMP 2.10.22 now includes HEIC support and AVIF support. Learn how to
...
When you export an image from the editor, select the file type "HEIF / AVIF" or use the extension ".avif." A prompt will appear in which you will be able to choose between several possible options.  
