...
Images compressed in AVIF usually take up half the storage space of JPEG and WebP. It uses the HEIF ISO standard and AV1 codec from Mozilla, Google, Cisco, and others. On the other hand, the CDN provider Cloudflare provides hosting and distribution services for websites to optimize content loading for the user.  
