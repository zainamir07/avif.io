...
See the <Link text="Next.js Documentation" href="https://nextjs.org/docs/api-reference/next/image#acceptable-formats" /> for more information.

## Next.js image component

All in all, it's a simple "Put this image in your project, add it to the component and we'll do the entire conversion and optimization" approach. While it converts images to both AVIF or WebP depending on the browser's support. Finally, the images loaded via CSS will not be optimized, although we pray that this will be the case in future versions.
