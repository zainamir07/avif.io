---
description: Find out how you can use AVIF images in Paint.NET.
title: Paint.NET AVIF support
url: blog/tutorials/use-avif-in-paintnet/
...
sources:
  ...
  - getpaint.net/
  - online-tech-tips.com/software-reviews/a-beginners-guide-to-paint-net-how-does-it-differ-from-photoshop/
  - forums.getpaint.net/topic/116233-avif-filetype-08-02-2021/
  - forums.getpaint.net/topic/116137-request-save-as-avif/
  - deskmodder.de/blog/2020/10/24/paint-net-4-2-14-avif-bilder-koennen-nun-auch-gespeichert-werden/
  - github.com/0xC0000054/pdn-avif
  - reddit.com/r/AV1/comments/czpray/paintnet_adding_av1_avif_decoding_in_v422/
  - ionos.com/digitalguide/websites/web-design/avif-format/
