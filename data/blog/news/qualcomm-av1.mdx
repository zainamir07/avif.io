...
The AV1 video codec shows anywhere up to 30% more efficient compression than HEVC. However, AV1 encoding takes a long time. AV1 is expected to make significant improvements in this area. It is a problem that AOM must resolve before widespread adoption is possible.
