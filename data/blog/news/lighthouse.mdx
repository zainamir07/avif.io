...
description: Google Lighthouse now incorporates AVIF into its recommendations for optimizing websites.
keyword: Lighthouse suggests AVIF
category: news
url: blog/news/lighthouse/
...
Google Lighthouse now incorporates AVIF into its recommendations for optimizing websites, in addition to other modern image formats, providing significant savings in file size thanks to the inclusion of AVIF.
...
The Google Lighthouse now incorporates AVIF into its recommendations, and that's in the section "Provide images in modern formats".
...
Future usage of AVIF could certainly provide a good alternative to existing file formats, thereby reducing the loading time of websites. However, as not all browsers support AVIF, an alternative should always be offered.
