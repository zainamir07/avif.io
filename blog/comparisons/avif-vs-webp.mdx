...
The WebP format was designed to provide more outstanding quality while encoding images with similar file sizes to JPEG. While WebP achieves this, **the newer and more advanced AVIF image format performs better in compression to appeal ratio**on lossy and lossless compression.
...
**Both AVIF and WEBP support animation** – however, with AVIF's heritage as a video codec, encoding animation with AVIF is more efficient with AVIF than WEBP. **Sequenced AVIF files have much smaller file sizes than animated WEBP**. However, even WEBP beats out legacy formats like GIF and aPNG.
