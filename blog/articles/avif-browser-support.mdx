...
<Link className="block" text="✔️Safari" href="/blog/tutorials/safari/" />
<Link className="block" text="✔️Safari on iOS" href="/blog/tutorials/safari/" />
<Link
  className="block"
  text="✔️Samsung Internet"
  href="/blog/tutorials/samsunginternet/"
/>
<Link className="block" text="✔️Tor" href="/blog/tutorials/tor/" />
<Link className="block" text="✔️Vivaldi" href="/blog/tutorials/vivaldi/" />
<Link className="block" text="✔️Waterfox" href="/blog/tutorials/waterfox/" />

## Browsers not supporting AVIF

<Link className="block" text="❌Baidu Browser" href="/blog/tutorials/baidu/" />
...
<Link className="block" text="❌Maxthon" href="/blog/tutorials/maxthon/" />
<Link className="block" text="❌Opera Mini" href="/blog/tutorials/opera/" />
<Link className="block" text="❌Pale Moon" href="/blog/tutorials/palemoon/" />
<Link className="block" text="❌QQ Browser" href="/blog/tutorials/qq/" />
<Link className="block" text="❌Torch" href="/blog/tutorials/torch/" />
