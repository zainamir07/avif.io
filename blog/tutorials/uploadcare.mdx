...
Uploadcare Image processing pipeline now supports AVIF images as a source. Processed images could also be served as AVIF using the `-/format/auto/` operation, if a client supports this and the image meets some circumstances.
